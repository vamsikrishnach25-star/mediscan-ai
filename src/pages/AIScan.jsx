        ...
        <body>
          ...
          <div class="section">
            ...
            <div class="warning" style="margin-top:12px;">
              <p style="font-weight:bold; color:#dc2626; margin:0 0 8px 0;">⚠️ Warning Signs:</p>
...
Analyzed by MediScan AI — mediscan-ai-bay.vercel.app
    ...
    if (navigator.share) {
      try {
        await navigator.share({ title: "MediScan AI Report", text: shareText });
      } catch (err) {
    ...
    try {
      await emailjs.send(
        ...
        "template_53u4gcb",
        {
          ...
          summary: result.summary || "",
          foods_to_eat: result.food_suggestions?.foods_to_eat?.join(", ") || "N/A",
          foods_to_avoid: result.food_suggestions?.foods_to_avoid?.join(", ") || "N/A",
          specialist: result.doctor_advice?.specialist_to_see || "General Physician",
          urgency: result.doctor_advice?.urgency || "Routine",
          recommendations: result.recommendations?.join(", ") || "N/A",
        },
        "x3y7remh8mWBZJQyF"
      );
      setEmailSent(true);
          ...
          <div className="flex flex-wrap gap-3 justify-end">
            <button onClick={handleVoice}
              className={`flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium transition ${
                speaking ? "bg-red-100 text-red-600 dark:bg-red-900/20"
            ...
            <button onClick={() => setShowEmailModal(true)}
              className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium bg-orange-100 text-orange-600 dark:bg-orange-900/20 hover:bg-orange-200 transition">
              <span>📧</span>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4"
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 w-full max-w-md shadow-2xl"
            ...
            <div className="text-center mb-4">
              ...
              <h3 className="text-lg font-bold mt-2">Send Report to Email</h3>
            ...
            <input
              ...
              className="w-full border dark:border-gray-600 rounded-xl px-4 py-3 mb-4 dark:bg-gray-700 dark:text-white outline-none focus:border-orange-500 transition"
            />
            <div className="flex gap-3">
              <button
                onClick={() => setShowEmailModal(false)}
                className="flex-1 py-3 rounded-xl bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 font-medium hover:bg-gray-200 transition">
                Cancel
              </button>
              <button
